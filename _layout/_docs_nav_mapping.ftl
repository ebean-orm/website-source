...
<@smallnav activeCheck="${list!''}" url="/docs/mapping/collections" title="Collections">
<ul class="nav">
...
<@smallnav activeCheck="" url="/docs/mapping#validation-annotations" title="@Size and @NotNull"></@smallnav>
<@smallnav activeCheck="" url="/docs/mapping#limitations" title="Mapping limitations"></@smallnav>
